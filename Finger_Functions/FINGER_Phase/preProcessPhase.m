function concatData = preProcessPhase(username,subname,saveBool,concatData)
% Input: 
% username = e.g. 'Sumner'
% subname = e.g. 'LASF' 
%
...
% eeg = array of signals as vectors (channel x samples)
%
%
% Outputs: 
...
warning('NO HEAD MODEL PRESENT!')
warning('No LaPlacian Filter (no head model)')
concatData.params.laPlacian = false;
nChans = 16;
